# Documentação AlfaSchool

Bem-vindo à documentação detalhada do sistema AlfaSchool. Esta documentação foi criada para ajudar desenvolvedores a entender como o sistema funciona e como contribuir.
...
1. Crie uma branch para sua documentação
2. Faça as alterações nos arquivos apropriados
