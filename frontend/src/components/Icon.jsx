...
const SVG_PATHS = {
  LayoutDashboard: "M4 5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5zm10 0a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1V5zM4 15a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-4zm10 0a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-4z",
  Building2: "M6 2h12v20H6V2zm-4 5h4v15H2V7zm16 0h4v15h-4V7zm-8 4h4v2h-4v-2zm0-4h4v2h-4V7zm0 8h4v2h-4v-2zm0 4h4v4h-4v-4z",
  School: "M2 10l10-8 10 8v12H2V10zm2 2v8h16v-8l-8-6.4L4 12zm5 2h2v6H9v-6zm4 0h2v6h-2v-6z",
  ...
  Users: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm8 2a4 4 0 0 1 0 8",
  GraduationCap: "M22 10v6M2 10l10-5 10 5-10 5-10-5zm10 5v9M17 13v5a5 5 0 0 1-10 0v-5",
  ClipboardList: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2M9 12h6M9 16h4",
  Cpu: "M18 4H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM9 9h6v6H9z",
  UserCog: "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M8.5 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z",
  ...
  Percent: "M19 5 5 19M6.5 5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM17.5 16a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z",
  ...
  Users2: "M14 19a6 6 0 0 0-12 0M7 13A4 4 0 1 0 7 5a4 4 0 0 0 0 8zM21 19a6 6 0 0 0-9-5.2M16 8a4 4 0 1 1-1.16 7.84",
  BookMarked: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 4.5A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20M9 10h6",
  CalendarCheck: "M3 4h18v18H3V4zm5-2v4M16 2v4M3 10h18M9 16l2 2 4-4",
  ClipboardCheck: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4",
  ...
  BookCheck: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 4.5A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20M9 9.5l2 2 4-4",
};
...
export function Icon({ name, size = 16, className = "", style = {} }) {
  ...
  return (
    <svg
      ...
      className={className}
      style={{ display: "inline-flex", flexShrink: 0, verticalAlign: "middle", ...style }}
      aria-hidden="true"
    >
      <path d={d} />
    </svg>
